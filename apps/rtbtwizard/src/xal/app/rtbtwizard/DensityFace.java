...
public class DensityFace extends JPanel{
    ...
    //This correction values come from J.Holmes' July 8, 2016 Tech Note
    //This value replaces a hardcoded 'magic number' correction. 2017-01-10  - nhe
    private double pfracOnTarget = 0.98;//Material dependent percent beam reaching target. Al=0.98, Inconel=0.96
    ...
    public void setAction(){
        ...
        solvebutton.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e) {
                ...
                double peakFracNorm=1.25e-4;//This number normalizes the density as per the definition in the SNS Wiki under Physics/Target
                ...
                for(int i=0; i<nrows; i++){
                    if((Boolean)datatable.getValueAt(i,1) == true){
                        ...
                        rho_target=rho_wire*areafac * pfracOnTarget;
						rho_target_raw = rho_wire*areafacraw;
                        rho_window=rho_wire*wareafac;
                        peakfac = rho_target/peakFracNorm/np;
