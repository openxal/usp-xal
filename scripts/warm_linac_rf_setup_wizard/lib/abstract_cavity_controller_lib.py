...
class Abstract_Cavity_Controller:
	def __init__(self,main_loop_controller,cav_wrapper):
		...
		self.cav_amp_backward_steps_mult_text =  DoubleInputTextField(1.0,DecimalFormat("##.##"),5)
		...
		self.cav_amp_wait_time_mult_text =  DoubleInputTextField(3.0,DecimalFormat("##.##"),5)
		...
		self.safe_relative_amp_up_text = DoubleInputTextField(7.0,DecimalFormat("##.##"),5)
		...
		self.safe_relative_amp_down_text = DoubleInputTextField(7.0,DecimalFormat("##.##"),5)
		...
		self.guess_phase_shift_text =  DoubleInputTextField(0.0,DecimalFormat("###.##"),6)
		...
		self.guess_cav_amp_shift_text =  DoubleInputTextField(0.0,DecimalFormat("###.##"),6)
