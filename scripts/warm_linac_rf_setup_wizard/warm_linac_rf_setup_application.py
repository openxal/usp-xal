...
from lib.dtl_acceptance_scans_controller_lib import DTL_Acceptance_Scans_Controller
...
class Warm_Linac_RF_SetUp_OpenXAL_Document(AcceleratorDocument):
	...
	def saveDocumentAs(	self,url):
		...
		self.warm_linac_rf_setup_document.dtl_acceptance_scans_controller.writeDataToXML(root_da)
		da.writeToUrl(url)
	...
	def readWarm_Linac_RF_SetUp_Document(self,url):
		...
		self.warm_linac_rf_setup_document.dtl_acceptance_scans_controller.readDataFromXML(root_da)
