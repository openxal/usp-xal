...
class CavityTwissParams_Panel(JPanel):
	def __init__(self,scl_long_tuneup_controller):
		...
		self.current_text = DoubleInputTextField(32.0,DecimalFormat("###.##"),8)
...
class StartStopAnalysis_Panel(JPanel):
	def __init__(self,scl_long_tuneup_controller):
		...
		self.iterations_text = DoubleInputTextField(200.0,DecimalFormat("#####"),8)
		iterations_lbl = JLabel("Fit Iterations=",JLabel.RIGHT)
		self.chi2_txt = DoubleInputTextField(0.0,DecimalFormat("0.###E0"),10)
