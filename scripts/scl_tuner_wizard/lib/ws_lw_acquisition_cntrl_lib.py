...
class GaussFitDataPanel(LabelDoulbeTextFieldPanel):
	def __init__(self):
		...
		dbl_text_filed1 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
		dbl_text_filed2 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
		dbl_text_filed3 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
		dbl_text_filed4 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
		dbl_text_filed5 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
		dbl_text_filed6 = DoubleInputTextField(0.,DecimalFormat("0.###E0#"),10)
