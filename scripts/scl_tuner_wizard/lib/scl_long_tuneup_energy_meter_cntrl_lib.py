...
class InitStartStopStatistics_Panel(JPanel):
	def __init__(self,scl_long_tuneup_controller):
		...
		self.counter_text = DoubleInputTextField(0.,DecimalFormat("####"),4)
		buffer_size_lbl = JLabel("  Buffer Size=",JLabel.RIGHT)
		self.buffer_size_text = DoubleInputTextField(10.,DecimalFormat("###"),4)
		...
		self.energy_guess_text = DoubleInputTextField(0.,DecimalFormat("####.######"),12)
		...
		self.energy_err_text = DoubleInputTextField(0.,DecimalFormat("####.######"),12)
